...
not a plan, it is running**. The archive holds **123 sealed artefacts** [measured: counted
at commit `968454efa5f9` of the evidence repository, so that you count exactly the same thing —
...
*We say «sealed artefacts» and not «runs» deliberately: **93 are runs** and the rest are
