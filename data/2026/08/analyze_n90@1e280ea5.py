...
ART = os.path.join(QRUN, "resultados_n90", "RQ-EXP-N90-LOPO@116e42d4.json")
OUT = os.path.join(AQUI, "n90_result.json")
...
if __name__ == "__main__":
    ...
    res = {
        ...
        "artefacto": {"archivo": os.path.basename(ART),
                      "sha256": "sha256:116e42d413442898a03e694d56139ddc5622600400617a1"
                                "bba816ccb40ef8cf1"},
