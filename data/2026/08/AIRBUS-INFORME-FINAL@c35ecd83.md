...
- **The sweep artifacts are not sealed yet.** They are produced, reproducible and public, but the seal and the anchor are a separate step by the lab and the notary, and it has not run for these. We say so rather than let you assume. **[measured]**
...
| artifact | sha256 |
|---|---|
| `barrido_airbus.json` | `f7d15b36b98d7d00176723aa53dd1e244defceda10423eb647847ef0d44ce5a5` |
| `nolinealidad_donde_vive.json` | `d120124444713d3dad2e0beb636a024ef02609237938adc3afc1af8ac552455e` |
