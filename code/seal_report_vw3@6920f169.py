...
ESPERADOS = {
    ...
    "ENTREGABLE-VW-EN.md": "sha256:490510bd2c89fb9abc6680ece7bef9bd1887e2c0d8eeffff7bdd4dae95af2f27",
    "1_Rosetta-Quantum-VW-Deliverable.pdf":
        "sha256:df876a9fde90524ea368151fe067726105575dbe9eeaff04e06c6c346abdd1fa",
}
# ------------------------------------------------------------------ GUARDIA 1
hashes = {}
...
NOMBRE = ("RosettaQ__REPORT__RQ-REPORT-VW-003__%s__"
          "lo-que-el-espectro-de-llava-dice-sobre-la-compresion-tensorial.json" % STAMP)

doc = {"meta": {
    "file_name": NOMBRE, "file_id": "RQ-REPORT-VW-003", "type": "REPORT",
    "is_demo": False,
    "scope_note":
    ...
    "sustituye_a": {
        "file_id": "RQ-REPORT-VW-002",
        "por_que": "Nicholas pidio una revision del informe y una LECTURA COMPLETA —no los "
                   "guardias— encontro DIEZ defectos. El grave: el cuerpo decia «perdemos "
                   "contra la variante ingenua en todas las matrices» y «no hay ningun "
                   "subconjunto donde ganemos», mientras el ABSTRACT decia «ganamos en 2 de "
                   "21». Las dos frases en el mismo documento; el abstract tenia razon. "
                   "Segundo en importancia: el 1,02x del §1 —el diagnostico del informe— esta "
                   "medido sobre OTRO conjunto (13 matrices, 5 profundidades) y no se decia, "
                   "asi que el lector asumia las 21 del resto. Los otros ocho: el abstract "
                   "conservaba la frase floja que el cuerpo ya habia reemplazado; dos "
                   "referencias cruzadas rotas por la renumeracion; una analogia entre "
                   "secciones que no se sostenia; la formula «todo resultado que pudimos "
                   "encontrar» en vez de la base especifica; el guion citado con un nombre "
                   "distinto del que viaja en el paquete; un «25 matrices» sin explicar "
                   "contra las 21 de las tablas; comillas españolas en un texto en ingles; y "
                   "el simbolo § usado para nuestras secciones Y las del enunciado sin "
                   "distinguirlas. NINGUNO lo caza un guardia: todos salen de leer. ",
