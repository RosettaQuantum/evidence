...
ESPERADOS = {
    ...
    "ENTREGABLE-VW-EN.md": "sha256:070bf5dd4279f17451bcf39b3a05f4135f65a13ad9077378020a65aa64361683",
    "1_Rosetta-Quantum-VW-Deliverable.pdf":
        "sha256:1f92905a2b78907ec70cf2da4dd7bfb013c0f4dc0823e4a8067e08124bfce353",
}
# ------------------------------------------------------------------ GUARDIA 1
hashes = {}
...
NOMBRE = ("RosettaQ__REPORT__RQ-REPORT-VW-001__%s__"
          "lo-que-el-espectro-de-llava-dice-sobre-la-compresion-tensorial.json" % STAMP)

doc = {"meta": {
    "file_name": NOMBRE, "file_id": "RQ-REPORT-VW-001", "type": "REPORT",
    "is_demo": False,
    "scope_note":
        "Entregable del track VW (Compression, Autonomous Driving) del 2026 Global Quantum + "
    ...
    "donde": {"paquete": "evidence-staging/PAQUETE-VW"},
    "porque": {
