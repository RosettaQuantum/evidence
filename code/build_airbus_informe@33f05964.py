...
w("You asked for a quantum solver for the 2D convecting Taylor-Green vortex, and for the "
  ...
  "end to end. Four things came out, and the last two are about your benchmark rather than about us.")
w()
...
# ---------------------------------------------------------------- 6 · ataques
w("## 6 · What your benchmark can detect — measured")
w()
...
w("**The price, stated up front.** A manufactured solution adds a source term: this is "
  ...
  "active, not time-to-solution against Reynolds. **It does not replace the axis in §4; it "
  ...
  "squares. It changes no conclusion and we say it anyway.")
w()
...
w("**And the degenerate class is larger than your case.** It is not «the Taylor-Green "
  ...
  "explains the rotated vortex in §5 without appealing to any coincidence. **[measured]**"
  % sci(_car["error_del_solver_sin_no_linealidad"]))
w()
...
w("**And that is the sentence we would put in front of your committee:** you chose this "
  ...
  "fact.** That is not a flaw anyone introduced; it is structure — and §5 gives the law "
  "that repairs it, with the threshold above as the dial.")
w()
w("## 7 · What we did to kill our own result")
w()
...
# ---------------------------------------------------------------- 9 · anexo REFORMS
w("## 10 · Annex — the external yardstick")
w()
