...
def regenera_igual(gen, md, nombre_salida):
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        try:
            r = subprocess.run([sys.executable, cop], cwd=AQUI, capture_output=True, text=True)
            if r.returncode != 0:
...
NOMBRE = ("RosettaQ__REPORT__RQ-REPORT-HSBC-001__%s__"
          "entregable-track-hsbc-es-y-en.json" % STAMP)
doc = {"meta": {
    "file_name": NOMBRE, "file_id": "RQ-REPORT-HSBC-001", "type": "REPORT", "is_demo": False,
